+++
title = "Join our research team in Toulouse!"
date = 2024-09-13
minimal = true
url = "/fixed/joinus"
+++
...
![](/img/headers/toulouse.jpg)

If you are (or know someone) **interested in complementing or strengthening our genomics/epigenomics approaches**, feel free to contact us! [:email:](mailto:jean.monlong@inserm.fr)[:email:](mailto:jean.monlong@inserm.fr)
...
- Jean Monlong ([jean.monlong@inserm.fr](mailto:jean.monlong@inserm.fr))
    - [https://jmonlong.github.io/](https://jmonlong.github.io/)
    - [Human Pangenome Reference Consortium](https://humanpangenome.org/)
- Sarah Djebali ([sarah.djebali@inserm.fr](wmailto:sarah.djebali@inserm.fr))
    - [http://www.irsd.fr/sarah-djebali.html](http://www.irsd.fr/sarah-djebali.html)
    - [ENCODE/MouseENCODE](https://www.encodeproject.org/)
